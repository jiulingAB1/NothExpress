        ...
        <a-tab-pane key="tab1" tab="账号密码登录">
          ...
          <a-form-item>
            <a-input
              ...
              v-decorator="[
                'account',
                { initialValue:'user001', rules: [{ required: true, message: '请输入帐户名' }, { validator: handleUsernameOrEmail }], validateTrigger: 'change'}
              ]"
            >
...
export default {
  ...
  methods: {
    ...
    loginSuccess (res) {
      this.$router.push({ path: '/DataStatistics/analyse' })
      this.isLoginError = false
      // 加载字典所有字典到缓存中
